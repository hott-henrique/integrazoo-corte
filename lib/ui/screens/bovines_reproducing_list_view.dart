...
class _BovinesReproducingListView extends State<BovinesReproducingListView> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: ReproductionService.countBovinesReproducing(),
...
class _PaginateBovinesReproducing extends State<PaginateBovinesReproducing> {
  ...
  Widget buildReproductions_() {
    return FutureBuilder(
      future: ReproductionService.getBovinesReproducing(pageSize, page),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return AlertDialog(
              ...
              actions: [
                Center(
                  child: TextButton(
                    onPressed: () async {
                      await ReproductionService.delete(widget.reproduction.id);
