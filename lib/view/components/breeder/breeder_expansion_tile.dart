...
class BreederExpansionTileState extends State<BreederExpansionTile> {
  ...
  Future<List<dynamic>> get _childrenCountBySexFutures => Future.wait([
    BreederController.countChildrenOfSex(widget.breeder.name, Sex.female),
    BreederController.countChildrenOfSex(widget.breeder.name, Sex.male),
  ]);

  Future<List<dynamic>> get _weigthInfo => Future.wait([
    BreederController.getAverageBirthWeight(widget.breeder.name),
    BreederController.getAverageWeaningWeight(widget.breeder.name),
  ]);
