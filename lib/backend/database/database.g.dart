...
class $YearlingWeightsTable extends YearlingWeights
    with TableInfo<$YearlingWeightsTable, YearlingWeight> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $YearlingWeightsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _bovineMeta = const VerificationMeta('bovine');
  @override
  late final GeneratedColumn<int> bovine = GeneratedColumn<int>(
      'bovine', aliasedName, false,
  ...
  late final GeneratedColumn<double> value = GeneratedColumn<double>(
      ...
      check: () => ComparableExpr(value).isBiggerThan(const Constant(0.0)),
      type: DriftSqlType.double,
      requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [bovine, value];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'yearling_weights';
  @override
  VerificationContext validateIntegrity(Insertable<YearlingWeight> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('bovine')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {bovine};
  @override
  YearlingWeight map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return YearlingWeight(
      bovine: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}bovine'])!,
  ...
  @override
  $YearlingWeightsTable createAlias(String alias) {
    return $YearlingWeightsTable(attachedDatabase, alias);
  }
}

class YearlingWeight extends DataClass implements Insertable<YearlingWeight> {
  final int bovine;
  final double value;
  const YearlingWeight({required this.bovine, required this.value});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['bovine'] = Variable<int>(bovine);
  ...
  YearlingWeightsCompanion toCompanion(bool nullToAbsent) {
    return YearlingWeightsCompanion(
      bovine: Value(bovine),
      value: Value(value),
    );
  }

  factory YearlingWeight.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return YearlingWeight(
      bovine: serializer.fromJson<int>(json['bovine']),
  ...
  YearlingWeight copyWith({int? bovine, double? value}) => YearlingWeight(
        bovine: bovine ?? this.bovine,
        value: value ?? this.value,
      );
  YearlingWeight copyWithCompanion(YearlingWeightsCompanion data) {
    return YearlingWeight(
      bovine: data.bovine.present ? data.bovine.value : this.bovine,
  ...
  @override
  String toString() {
    return (StringBuffer('YearlingWeight(')
          ..write('bovine: $bovine, ')
          ..write('value: $value')
          ..write(')'))
        .toString();
  ...
  @override
  int get hashCode => Object.hash(bovine, value);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is YearlingWeight &&
          other.bovine == this.bovine &&
          other.value == this.value);
}

class YearlingWeightsCompanion extends UpdateCompanion<YearlingWeight> {
  final Value<int> bovine;
  final Value<double> value;
  const YearlingWeightsCompanion({
    this.bovine = const Value.absent(),
    this.value = const Value.absent(),
  });
  YearlingWeightsCompanion.insert({
    this.bovine = const Value.absent(),
    required double value,
  }) : value = Value(value);
  static Insertable<YearlingWeight> custom({
    Expression<int>? bovine,
  ...
  YearlingWeightsCompanion copyWith(
      {Value<int>? bovine, Value<double>? value}) {
    return YearlingWeightsCompanion(
      bovine: bovine ?? this.bovine,
      value: value ?? this.value,
    );
  ...
  @override
  String toString() {
    return (StringBuffer('YearlingWeightsCompanion(')
          ..write('bovine: $bovine, ')
          ..write('value: $value')
          ..write(')'))
        .toString();
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $YearlingWeightsTable yearlingWeights =
      $YearlingWeightsTable(this);
        ...
        [
          ...
          WritePropagation(
            on: TableUpdateQuery.onTableName('bovines',
                limitUpdateKind: UpdateKind.delete),
            result: [
              TableUpdate('yearling_weights', kind: UpdateKind.delete),
            ],
          ),
          WritePropagation(
            on: TableUpdateQuery.onTableName('bovines',
...
final class $$BovinesTableReferences
  ...
  static MultiTypedResultKey<$YearlingWeightsTable, List<YearlingWeight>>
      _yearlingWeightsRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.yearlingWeights,
              aliasName: $_aliasNameGenerator(
                  db.bovines.earring, db.yearlingWeights.bovine));

  $$YearlingWeightsTableProcessedTableManager get yearlingWeightsRefs {
    final manager =
        $$YearlingWeightsTableTableManager($_db, $_db.yearlingWeights)
            .filter((f) => f.bovine.earring($_item.earring));

    final cache =
        $_typedResult.readTableOrNull(_yearlingWeightsRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
...
class $$BovinesTableFilterComposer
  ...
  Expression<bool> yearlingWeightsRefs(
      Expression<bool> Function($$YearlingWeightsTableFilterComposer f) f) {
    final $$YearlingWeightsTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.earring,
        referencedTable: $db.yearlingWeights,
        getReferencedColumn: (t) => t.bovine,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
            $$YearlingWeightsTableFilterComposer(
              $db: $db,
              $table: $db.yearlingWeights,
              $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
              joinBuilder: joinBuilder,
              $removeJoinBuilderFromRootComposer:
                  $removeJoinBuilderFromRootComposer,
...
class $$BovinesTableAnnotationComposer
  ...
  Expression<T> yearlingWeightsRefs<T extends Object>(
      Expression<T> Function($$YearlingWeightsTableAnnotationComposer a) f) {
    final $$YearlingWeightsTableAnnotationComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.earring,
        referencedTable: $db.yearlingWeights,
        getReferencedColumn: (t) => t.bovine,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
            $$YearlingWeightsTableAnnotationComposer(
              $db: $db,
              $table: $db.yearlingWeights,
              $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
              joinBuilder: joinBuilder,
          ...
          prefetchHooksCallback: (
            ...
            return PrefetchHooks(
              ...
              explicitlyWatchedTables: [
                ...
                if (yearlingWeightsRefs) db.yearlingWeights,
                    ...
                    await $_getPrefetchedData(
                        ...
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.bovine == item.earring),
                        typedResults: items),
                  if (yearlingWeightsRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable: $$BovinesTableReferences
                            ._yearlingWeightsRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$BovinesTableReferences(db, table, p0)
                                .yearlingWeightsRefs,
                        referencedItemsForCurrentItem:
...
typedef $$WeaningsTableProcessedTableManager = ProcessedTableManager<
    ...
    Weaning,
    PrefetchHooks Function({bool bovine})>;
typedef $$YearlingWeightsTableCreateCompanionBuilder = YearlingWeightsCompanion
    Function({
  Value<int> bovine,
  required double value,
});
typedef $$YearlingWeightsTableUpdateCompanionBuilder = YearlingWeightsCompanion
    Function({
  Value<int> bovine,
  Value<double> value,
});

final class $$YearlingWeightsTableReferences extends BaseReferences<
    _$AppDatabase, $YearlingWeightsTable, YearlingWeight> {
  $$YearlingWeightsTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static $BovinesTable _bovineTable(_$AppDatabase db) => db.bovines.createAlias(
      $_aliasNameGenerator(db.yearlingWeights.bovine, db.bovines.earring));
...
class $$YearlingWeightsTableFilterComposer
    extends Composer<_$AppDatabase, $YearlingWeightsTable> {
  $$YearlingWeightsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$YearlingWeightsTableOrderingComposer
    extends Composer<_$AppDatabase, $YearlingWeightsTable> {
  $$YearlingWeightsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$YearlingWeightsTableAnnotationComposer
    extends Composer<_$AppDatabase, $YearlingWeightsTable> {
  $$YearlingWeightsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$YearlingWeightsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $YearlingWeightsTable,
    YearlingWeight,
    $$YearlingWeightsTableFilterComposer,
    $$YearlingWeightsTableOrderingComposer,
    $$YearlingWeightsTableAnnotationComposer,
    $$YearlingWeightsTableCreateCompanionBuilder,
    $$YearlingWeightsTableUpdateCompanionBuilder,
    (YearlingWeight, $$YearlingWeightsTableReferences),
    YearlingWeight,
    PrefetchHooks Function({bool bovine})> {
  $$YearlingWeightsTableTableManager(
      _$AppDatabase db, $YearlingWeightsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$YearlingWeightsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$YearlingWeightsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$YearlingWeightsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<int> bovine = const Value.absent(),
            Value<double> value = const Value.absent(),
          }) =>
              YearlingWeightsCompanion(
            bovine: bovine,
            value: value,
          ),
          createCompanionCallback: ({
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable(table),
                    $$YearlingWeightsTableReferences(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: ({bovine = false}) {
            return PrefetchHooks(
              ...
              addJoins: <
                ...
                if (bovine) {
                  state = state.withJoin(
                    ...
                    currentColumn: table.bovine,
                    referencedTable:
                        $$YearlingWeightsTableReferences._bovineTable(db),
                    referencedColumn: $$YearlingWeightsTableReferences
                        ._bovineTable(db)
                        .earring,
                  ) as T;
                }
...
typedef $$YearlingWeightsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $YearlingWeightsTable,
    YearlingWeight,
    $$YearlingWeightsTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$YearlingWeightsTableTableManager get yearlingWeights =>
      $$YearlingWeightsTableTableManager(_db, _db.yearlingWeights);
